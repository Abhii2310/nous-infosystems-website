...
export default function AIProductEngineering() {
    return (
        <main style={{ minHeight: '100vh', background: '#f8f9fc', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: 'Inter, sans-serif' }}>
            <div style={{ maxWidth: 640, padding: '64px 32px', textAlign: 'center' }}>
                ...
                <span style={{ display: 'inline-flex', padding: '5px 14px', borderRadius: 100, background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.18)', fontSize: 12, fontWeight: 700, color: '#6366f1', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: 20 }}>Service</span>
                <h1 style={{ fontSize: 40, fontWeight: 900, letterSpacing: '-0.04em', color: '#0a0f1e', marginBottom: 16 }}>AI-led Product Engineering</h1>
                <p style={{ fontSize: 17, color: '#6b7280', lineHeight: 1.7, marginBottom: 32 }}>
                    Build next-generation applications with intelligence embedded at the core. LLM integration, RAG architectures, AI-first UX — we accelerate your time-to-market while delivering rich, contextual user experiences.
                </p>
                <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 40 }}>
                    {['LLM Integration', 'RAG Systems', 'AI-First Design', 'Copilot Development', 'Multimodal Apps'].map(t => (
